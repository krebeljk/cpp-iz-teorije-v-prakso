...
EBoard::EBoard()
    : matN_(7), state_(), solState_{0, 0, 0}, pegCount_(0), exhausted_(false) {
...
int EBoard::pegCount() { return pegCount_; }
...
void EBoard::makeNeighbours(int &I1, int &J1, int &I2, int &J2) {
  ...
  case 3: // dir 3: +I (next row)
    ...
    break;
  default:
    std::cout << "ERROR: solState_[2] out of bounds in "
                 "EBoard::validateCurrentDir()\n";
    break;
  }
}
...
bool EBoard::nextValidMoveIntent() {
  // enter at lease once
  do {
...
bool EBoard::exhausted() { return exhausted_; }
